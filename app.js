...
// Tillgänglig admin
app.get('/nyanvandare', userController.getSignup); // Måste få in första usern, Lägger till säkerheten efter
app.post('/nyanvandare', userController.postSignup); // Måste få in första user, Lägger till säkerheten efter
